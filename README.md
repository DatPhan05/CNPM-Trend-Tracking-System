...
│   │   ├── helpers/           # Các tiện ích và thư viện dùng chung (Prisma client)
│   │   ├── middlewares/       # Auth & Phân quyền
│   │   ├── models/            # Khai báo Database Models
│   │   ├── routes/            # Định tuyến API endpoints
│   │   ├── services/          # Xử lý logic gọi API ngoài (OpenAlex)
│   │   ├── validators/        # Các schema kiểm tra dữ liệu đầu vào (Validation)
│   │   ├── app.ts             # Khởi tạo Express app
│   │   ├── server.ts          # Entry point của Backend
│   │   └── swagger.config.ts  # Cấu hình Swagger OpenAPI
│   └── Dockerfile             
│
├── database/                  # 🗄️ Relational Database Architecture (Raw SQL)
│   ├── constraints/           # Ràng buộc dữ liệu (PK, FK, Check)
│   ├── config/                # Cấu hình Database
│   ├── docs/                  # Tài liệu Database (ERD, data dictionary)
│   ├── functions/             # Database functions
│   ├── indexes/               # Cấu hình Indexes
│   ├── migrations/            # SQL migration scripts
│   ├── procedures/            # Stored procedures
│   ├── schema/                # Database schema definitions
│   ├── seeds/                 # Dữ liệu khởi tạo (Seeds)
│   ├── tables/                # Scripts tạo bảng
...
│   │   ├── templates/         # UI templates dùng chung
│   │   ├── themes/            # Global CSS (Tailwind) & Themes
│   │   ├── utils/             # Các hàm tiện ích
│   │   ├── validators/        # Schema kiểm tra đầu vào form
│   │   ├── App.tsx            # Main router
