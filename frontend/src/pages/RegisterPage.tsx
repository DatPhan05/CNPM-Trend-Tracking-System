...
import { BookOpen, User, Mail, Lock, Building, ArrowRight, Eye, EyeOff, BadgeInfo } from 'lucide-react';
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post('/auth/register', {
        fullName: name,
        email,
        userName: loginUid || undefined,
        identityUid: loginUid || undefined,
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-12 md:px-16 lg:px-24 py-12">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="relative flex items-center py-5">
            ...
            <span className="flex-shrink-0 mx-4 text-muted-foreground text-sm font-medium">hoặc đăng ký thủ công</span>
            <div className="flex-grow border-t border-border" />
          </div>
          ...
          <form className="space-y-5" onSubmit={handleRegister}>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-foreground">CCCD tùy chọn</label>
              <div className="relative">
